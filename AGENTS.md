...
**Tests:** 491 tests across 10 test files, 100% line coverage
...
│   ├── smoke_test.sh          # End-to-end smoke test (20 checks)
...
| **Run tests** | `python3 -m pytest tests/ -v` (491 tests, 100% coverage) |
